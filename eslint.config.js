        ...
        rules: {
          'prefer-moti-over-reanimated': {
            meta: {
              ...
              docs: {
                description:
                  'Prefer Moti components over direct Reanimated usage for simple animations',
                ...
                ImportDeclaration(node) {
                  if (
                    ...
                    context.report({
                      node,
                      message:
                        'Consider using MotiView/MotiText instead of Animated.View/Text for simple animations',
                    });
                  }
                },
              };
                ...
                'FunctionDeclaration, FunctionExpression, ArrowFunctionExpression'(node) {
                  ...
                  if (body && body.type === 'BlockStatement' && body.body.length > 0) {
                    ...
                    if (
                      ...
                      const isValidWorklet =
                        parent.includes('useAnimatedStyle') ||
                      ...
                      if (!isValidWorklet) {
                        context.report({
                          node: firstStatement,
                          message:
                            'Worklet directive should only be used in actual worklet functions (useAnimatedStyle, runOnUI, etc.)',
                        });
                      }
                    }
                  }
